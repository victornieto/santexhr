	...
	$
			.extend( {
				tablesorter :new function() {
					...
					function multisort(table, sortList, cache) {
						...
						for ( var i = 0; i < l; i++) {
							...
							var s = 
								(order == 0) ? "sortNumeric"
										: "sortNumericDesc";
							if (getCachedSortType(table.config.parsers, c) == "text") {
								if (order == 0) {
									s = "sortText";
								} else {
									s = "sortTextDesc";
							...
							if (getCachedSortType(table.config.parsers, c) == "numericHack") {
								if (order == 0) {
									s = "sortNumericHack";
								} else {
									s = "sortNumericHackDesc";
								}
							}
							var e = "e" + i;
					...
					function sortNumericHack(a, b) {
						if (b < 0) {
							return -1;
						}
						return b - a ;
					};
					function sortNumericHackDesc(a, b) {
						if ( (a != b) && (a < 0)) {
							return 1;
						} else if ( (a != b) && (b < 0)) {
							return -1;
