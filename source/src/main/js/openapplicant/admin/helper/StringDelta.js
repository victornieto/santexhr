...
// Decompress keypresses, added by tommy
// keypressEvents = [m: milliseconds, t: text]
StringDelta.decompressKeypresses = function(keypressEvents) {
	StringDelta.setBase("");
	var len = keypressEvents.length;
	for(var i = 0; i < len; i++)
		keypressEvents[i].t = StringDelta.getString(keypressEvents[i].t);
